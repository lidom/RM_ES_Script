...
\iffalse{} {Proof. } \fi{}From the \emph{Law of Total Expectations} (i.e., \(\mathbb{E}(\mathbb{E}(y|\mathbf{x}))=\mathbb{E}(y)\)) it follows that
...
\protect\hypertarget{thm:UBS}{}{\label{thm:UBS} \iffalse (Unbiasedness of \(s^2\)) \fi{} }Under Assumptions 1.1-1.4, we have that: \[\mathbb{E}(s^2|\mathbf{X})=\sigma^2,\] and
