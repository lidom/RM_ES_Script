...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{y }\OperatorTok{%*%}\StringTok{ }\KeywordTok{t}\NormalTok{(y)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{t}\NormalTok{(y) }\OperatorTok{%*%}\StringTok{ }\NormalTok{y}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gasolin.consumption      <-}\StringTok{ }\NormalTok{auto.data}\OperatorTok{$}\NormalTok{MPG.city}
\NormalTok{car.weight               <-}\StringTok{ }\NormalTok{auto.data}\OperatorTok{$}\NormalTok{Weight}
\CommentTok{## Take a look at the first elements of these vectors:}
\KeywordTok{head}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(gasolin.consumption,car.weight))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{alpha <-}\StringTok{ }\NormalTok{lm.summary}\OperatorTok{$}\NormalTok{coefficients[}\DecValTok{1}\NormalTok{]}
\NormalTok{beta  <-}\StringTok{ }\NormalTok{lm.summary}\OperatorTok{$}\NormalTok{coefficients[}\DecValTok{2}\NormalTok{]}
...
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{y=}\NormalTok{gasolin.consumption, }\DataTypeTok{x=}\NormalTok{car.weight, }
     ...
     \DataTypeTok{ylab=}\StringTok{"Consumption (Miles/Gallon)"}\NormalTok{, }
     \DataTypeTok{main=}\StringTok{"Buy light-weight Cars!"}\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{a=}\NormalTok{alpha, }
       \DataTypeTok{b=}\NormalTok{beta, }\DataTypeTok{col=}\StringTok{"red"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{y   <-}\StringTok{ }\NormalTok{X }\OperatorTok{%*%}\StringTok{ }\NormalTok{beta.vec }\OperatorTok{+}\StringTok{ }\NormalTok{eps}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{## Computation of the beta-Vector:}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{myOLSFun <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(y, x, }\DataTypeTok{add.intercept=}\OtherTok{FALSE}\NormalTok{)\{}
  
  \CommentTok{## Number of Observations:}
\NormalTok{  n         <-}\StringTok{ }\KeywordTok{length}\NormalTok{(y)}
  
  \CommentTok{## Add an intercept to x:}
  \ControlFlowTok{if}\NormalTok{(add.intercept)\{}
\NormalTok{    Intercept <-}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{, n)}
\NormalTok{    x         <-}\StringTok{ }\KeywordTok{cbind}\NormalTok{(Intercept, x)}
\NormalTok{  \}}
  
  \CommentTok{## Estimation of the slope-parameters:}
\NormalTok{  beta.hat.vec <-}\StringTok{ }\KeywordTok{solve}\NormalTok{(}\KeywordTok{t}\NormalTok{(x) }\OperatorTok{%*%}\StringTok{ }\NormalTok{x) }\OperatorTok{%*%}\StringTok{ }\KeywordTok{t}\NormalTok{(x) }\OperatorTok{%*%}\StringTok{ }\NormalTok{y}
  
  \CommentTok{## Return the result:}
  \KeywordTok{return}\NormalTok{(beta.hat.vec)}
\NormalTok{\}}

\CommentTok{## Run the function:}
\KeywordTok{myOLSFun}\NormalTok{(}\DataTypeTok{y=}\NormalTok{y, }\DataTypeTok{x=}\NormalTok{X)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ChickWeight }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(Chick, Diet, Time, weight) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(Chick, Diet, Time) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{write_csv}\NormalTok{(}\StringTok{"ChickWeight.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(Time }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{21}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(}\StringTok{"knitr"}\NormalTok{) }\CommentTok{# to use the kable() function}
\NormalTok{prettySumCW <-}\StringTok{ }\NormalTok{sumCW }\OperatorTok{%>%}\StringTok{ }
\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\StringTok{`}\DataTypeTok{Mean (SD)}\StringTok{`}\NormalTok{ =}\StringTok{ }\KeywordTok{str_c}\NormalTok{(}\KeywordTok{format}\NormalTok{(Mean, }\DataTypeTok{digits=}\DecValTok{1}\NormalTok{),}
...
\StringTok{ }\KeywordTok{select}\NormalTok{(Diet, Time, N, }\StringTok{`}\DataTypeTok{Mean (SD)}\StringTok{`}\NormalTok{, Median, Range) }\OperatorTok{%>%}
\StringTok{ }\KeywordTok{arrange}\NormalTok{(Diet, Time) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(}\StringTok{"magrittr"}\NormalTok{, }\DataTypeTok{quietly =} \OtherTok{TRUE}\NormalTok{)}\CommentTok{# for using the pipe-operator: %>% }

\NormalTok{X           <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{19.20}\NormalTok{, }\FloatTok{17.40}\NormalTok{, }\FloatTok{18.50}\NormalTok{, }\FloatTok{16.50}\NormalTok{, }\FloatTok{18.90}\NormalTok{)}
\NormalTok{mu_}\DecValTok{0}\NormalTok{        <-}\StringTok{ }\DecValTok{17}        \CommentTok{# hypothetical mean}
\NormalTok{n           <-}\StringTok{ }\KeywordTok{length}\NormalTok{(X) }\CommentTok{# sample size}
\NormalTok{X_mean      <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(X)   }\CommentTok{# empirical mean}
\NormalTok{X_sd        <-}\StringTok{ }\KeywordTok{sd}\NormalTok{(X)     }\CommentTok{# empirical sd}
\CommentTok{# t-test statistic}
\NormalTok{t_test_stat <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(n)}\OperatorTok{*}\NormalTok{(X_mean }\OperatorTok{-}\StringTok{ }\NormalTok{mu_}\DecValTok{0}\NormalTok{)}\OperatorTok{/}\NormalTok{X_sd}

\CommentTok{# p-value for two-sided test}
\KeywordTok{c}\NormalTok{(}\KeywordTok{pt}\NormalTok{(}\DataTypeTok{q =}\NormalTok{ t_test_stat, }\DataTypeTok{df =}\NormalTok{ n}\DecValTok{-1}\NormalTok{, }\DataTypeTok{lower.tail =} \OtherTok{TRUE}\NormalTok{), }
  \KeywordTok{pt}\NormalTok{(}\DataTypeTok{q =}\NormalTok{ t_test_stat, }\DataTypeTok{df =}\NormalTok{ n}\DecValTok{-1}\NormalTok{, }\DataTypeTok{lower.tail =} \OtherTok{FALSE}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{min }\OperatorTok{*}\StringTok{ }\DecValTok{2}\NormalTok{ ->}\StringTok{ }\NormalTok{p_value}
      
\NormalTok{p_value }\OperatorTok{%>%}\StringTok{ }\KeywordTok{round}\NormalTok{(., }\DataTypeTok{digits =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{t.test}\NormalTok{(X, }\DataTypeTok{mu =}\NormalTok{ mu_}\DecValTok{0}\NormalTok{, }\DataTypeTok{alternative =} \StringTok{"two.sided"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{beta_Ztest_TwoSided <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(n, alpha, sigma, mu_}\DecValTok{0}\NormalTok{, mu)\{}
  \CommentTok{# (1-alpha/2)-quantile of N(0,1):}
\NormalTok{  z_upper        <-}\StringTok{ }\KeywordTok{qnorm}\NormalTok{(}\DataTypeTok{p =} \DecValTok{1}\OperatorTok{-}\NormalTok{alpha}\OperatorTok{/}\DecValTok{2}\NormalTok{)}
  \CommentTok{# location shift under H_1:}
\NormalTok{  location_shift <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(n) }\OperatorTok{*}\StringTok{ }\NormalTok{(mu }\OperatorTok{-}\StringTok{ }\NormalTok{mu_}\DecValTok{0}\NormalTok{)}\OperatorTok{/}\NormalTok{sigma}
  \CommentTok{# compute power}
\NormalTok{  power          <-}\StringTok{ }\DecValTok{1} \OperatorTok{-}\StringTok{ }\KeywordTok{pnorm}\NormalTok{( z_upper }\OperatorTok{-}\StringTok{ }\NormalTok{location_shift) }\OperatorTok{+}\StringTok{ }
\StringTok{                        }\KeywordTok{pnorm}\NormalTok{(}\OperatorTok{-}\NormalTok{z_upper }\OperatorTok{-}\StringTok{ }\NormalTok{location_shift)}
  \KeywordTok{return}\NormalTok{(power)}
\NormalTok{\}}

\CommentTok{# Apply the function}
\NormalTok{n     <-}\StringTok{  }\DecValTok{9}
\NormalTok{sigma <-}\StringTok{  }\FloatTok{0.18}
\NormalTok{mu_}\DecValTok{0}\NormalTok{  <-}\StringTok{ }\FloatTok{18.3} 
\CommentTok{##}
\KeywordTok{c}\NormalTok{(}\KeywordTok{beta_Ztest_TwoSided}\NormalTok{(}\DataTypeTok{n =}\NormalTok{ n, }\DataTypeTok{alpha =} \FloatTok{0.05}\NormalTok{, }\DataTypeTok{sigma =}\NormalTok{ sigma, }\DataTypeTok{mu_0 =}\NormalTok{ mu_}\DecValTok{0}\NormalTok{, }\DataTypeTok{mu=}\FloatTok{18.35}\NormalTok{),}
  \KeywordTok{beta_Ztest_TwoSided}\NormalTok{(}\DataTypeTok{n =}\NormalTok{ n, }\DataTypeTok{alpha =} \FloatTok{0.05}\NormalTok{, }\DataTypeTok{sigma =}\NormalTok{ sigma, }\DataTypeTok{mu_0 =}\NormalTok{ mu_}\DecValTok{0}\NormalTok{, }\DataTypeTok{mu=}\FloatTok{18.50}\NormalTok{),}
  \KeywordTok{beta_Ztest_TwoSided}\NormalTok{(}\DataTypeTok{n =}\NormalTok{ n, }\DataTypeTok{alpha =} \FloatTok{0.01}\NormalTok{, }\DataTypeTok{sigma =}\NormalTok{ sigma, }\DataTypeTok{mu_0 =}\NormalTok{ mu_}\DecValTok{0}\NormalTok{, }\DataTypeTok{mu=}\FloatTok{18.50}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(}\StringTok{"tidyverse"}\NormalTok{, }\DataTypeTok{quietly =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{K <-}\StringTok{ }\DecValTok{100} \CommentTok{# number of regressors}
\NormalTok{n <-}\StringTok{ }\DecValTok{500} \CommentTok{# sample size}
...
\NormalTok{my_df <-}\StringTok{ }\KeywordTok{matrix}\NormalTok{(}\DataTypeTok{data =} \KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{n =}\NormalTok{ n}\OperatorTok{*}\NormalTok{K), }
                \DataTypeTok{nrow =}\NormalTok{ n, }\DataTypeTok{ncol =}\NormalTok{ K, }
                \DataTypeTok{dimnames =} \KeywordTok{list}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{"i."}\NormalTok{,}\DecValTok{1}\OperatorTok{:}\NormalTok{n), }
                                \KeywordTok{paste0}\NormalTok{(}\StringTok{"X."}\NormalTok{,}\DecValTok{1}\OperatorTok{:}\NormalTok{K))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{as_tibble}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Y =} \KeywordTok{rnorm}\NormalTok{(n)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# Adding a Y-variable that is independent of the X-variables}
\StringTok{  }\KeywordTok{select}\NormalTok{(Y, }\KeywordTok{everything}\NormalTok{())  }

\CommentTok{# OLS regression}
\NormalTok{OLS_result_df <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(Y }\OperatorTok{~}\StringTok{ }\NormalTok{. , }\DataTypeTok{data =}\NormalTok{ my_df) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{summary }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{broom}\OperatorTok{::}\KeywordTok{tidy}\NormalTok{()}


\NormalTok{Count_Signif <-}\StringTok{ }\NormalTok{OLS_result_df }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{!=}\StringTok{ '(Intercept)'}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{count}\NormalTok{(p.value }\OperatorTok{<}\StringTok{ }\FloatTok{0.05}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\section{Finite-Sample Properties of OLS}\label{finite-sample-properties-of-ols}}

\hypertarget{the-classical-linear-regression-model}{%
\subsection{The Classical Linear Regression Model}\label{the-classical-linear-regression-model}}
...
\iffalse{} {Proof. } \fi{} From the \emph{Law of Total Expectations} (i.e.,
...
\BeginKnitrBlock{proof}
\iffalse{} {Proof. } \fi{}The first result can be shown as following:
\begin{align*}
...
The vector of residuals \(\hat{\boldsymbol{\varepsilon}}\) has only \(n-K\) so-called \emph{degrees
...
\BeginKnitrBlock{proof}
\iffalse{} {Proof. } \fi{}- As a consequence of Prop. 3.1.2 we have for regressions with intercept:
...
\BeginKnitrBlock{proof}
\iffalse{} {Proof. } \fi{}Consider the sum of squared residuals,
...
\BeginKnitrBlock{proof}
\iffalse{} {Proof. } \fi{}The OLS estimator \(\hat{\boldsymbol{\beta}}_2\) is given by
...
\hypertarget{finite-sample-properties-of-ols-1}{%
\subsection{Finite-Sample Properties of OLS}\label{finite-sample-properties-of-ols-1}}
...
\BeginKnitrBlock{theorem}[Finite Sample Properties]
\protect\hypertarget{thm:GMT}{}{\label{thm:GMT} \iffalse (Finite Sample Properties) \fi{} }
...
\BeginKnitrBlock{proof}
\iffalse{} {Proof. } \fi{}In the following we show that \(\mathbb{E}(s^2|\mathbf{X})=\sigma^2\), where
...
\subsection{Asymptotics under the Classic Regression Model}\label{asymptotics-under-the-classic-regression-model}}
...
\textbf{Assumption 1.5\(^\ast\):} The sample \((\mathbf{x}_i,\varepsilon_i)\)
...
\BeginKnitrBlock{proof}
\iffalse{} {Proof. } \fi{}1st Part: Let define \[\begin{align*}
...
\BeginKnitrBlock{proof}
\iffalse{} {Proof. } \fi{}: We show the equivalent result that
...
implies convergence in distribution element-by-element, \textbf{but}
convergence in distribution element-by-element does not imply
\(\mathbf{z}_n\overset{d}\longrightarrow \mathbf{z}\).

\BeginKnitrBlock{proof}
\iffalse{} {Proof. } \fi{}Let's start with some rearrangements: \[\begin{align*}
\mathbf{b}-\boldsymbol{\beta}
&=(\mathbf{X}'\mathbf{X})^{-1}\mathbf{X}'\boldsymbol{\varepsilon}\\
&=(n^{-1}\mathbf{X}'\mathbf{X})^{-1}\frac{1}{n}\mathbf{X}'\boldsymbol{\varepsilon}\\
...
\CommentTok{## Setup a progressbar}
\CommentTok{#pb <- txtProgressBar(min = 0, max = m, style = 3)}

\ControlFlowTok{for}\NormalTok{(rpt }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{m)\{}
\NormalTok{  eps <-}\StringTok{ }\NormalTok{(X}\FloatTok{.3}\NormalTok{)}\OperatorTok{*}\KeywordTok{rnorm}\NormalTok{(n, }\DataTypeTok{mean=}\DecValTok{0}\NormalTok{, }\DataTypeTok{sd=}\DecValTok{1}\NormalTok{) }\CommentTok{# heteroscadastic error term}
\NormalTok{  y   <-}\StringTok{ }\NormalTok{X }\OperatorTok{%*%}\StringTok{ }\NormalTok{beta.vec }\OperatorTok{+}\StringTok{ }\NormalTok{eps         }\CommentTok{# Dependent variable}
  \CommentTok{## Estimation}
\NormalTok{  beta.hat <-}\StringTok{ }\KeywordTok{myOLSFun}\NormalTok{(}\DataTypeTok{y=}\NormalTok{y,}\DataTypeTok{x=}\NormalTok{X)}
  \CommentTok{## Save results}
\NormalTok{  beta.}\FloatTok{2.}\NormalTok{sim[rpt] <-}\StringTok{ }\NormalTok{beta.hat[}\DecValTok{2}\NormalTok{]}
\NormalTok{  beta.}\FloatTok{3.}\NormalTok{sim[rpt] <-}\StringTok{ }\NormalTok{beta.hat[}\DecValTok{3}\NormalTok{]}
...
\NormalTok{Var_beta_mat <-}\StringTok{ }\KeywordTok{solve}\NormalTok{(}\KeywordTok{t}\NormalTok{(X)}\OperatorTok{%*%}\NormalTok{X) }\OperatorTok{%*%}\StringTok{ }\KeywordTok{t}\NormalTok{(X) }\OperatorTok{%*%}\StringTok{ }\KeywordTok{diag}\NormalTok{((X}\FloatTok{.3}\NormalTok{)}\OperatorTok{^}\DecValTok{2}\NormalTok{) }\OperatorTok{%*%}\StringTok{ }\NormalTok{X }\OperatorTok{%*%}\StringTok{ }\KeywordTok{solve}\NormalTok{(}\KeywordTok{t}\NormalTok{(X)}\OperatorTok{%*%}\NormalTok{X)}

\CommentTok{## Plot results}
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\KeywordTok{hist}\NormalTok{(beta.}\FloatTok{2.}\NormalTok{sim, }\DataTypeTok{prob=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{main=}\KeywordTok{expression}\NormalTok{(}\KeywordTok{hat}\NormalTok{(beta)[}\DecValTok{2}\NormalTok{]), }\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\FloatTok{1.55}\NormalTok{))}
\KeywordTok{curve}\NormalTok{(}\KeywordTok{dnorm}\NormalTok{(x, }\DataTypeTok{mean=}\NormalTok{beta.vec[}\DecValTok{2}\NormalTok{], }\DataTypeTok{sd=}\KeywordTok{sqrt}\NormalTok{(Var_beta_mat[}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{])), }
...
\KeywordTok{hist}\NormalTok{(beta.}\FloatTok{3.}\NormalTok{sim, }\DataTypeTok{prob=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{main=}\KeywordTok{expression}\NormalTok{(}\KeywordTok{hat}\NormalTok{(beta)[}\DecValTok{3}\NormalTok{]), }\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,.}\DecValTok{75}\NormalTok{))}
\KeywordTok{curve}\NormalTok{(}\KeywordTok{dnorm}\NormalTok{(x, }\DataTypeTok{mean=}\NormalTok{beta.vec[}\DecValTok{3}\NormalTok{], }\DataTypeTok{sd=}\KeywordTok{sqrt}\NormalTok{(Var_beta_mat[}\DecValTok{3}\NormalTok{,}\DecValTok{3}\NormalTok{])), }
      \DataTypeTok{col=}\StringTok{"darkblue"}\NormalTok{, }\DataTypeTok{lwd=}\DecValTok{2}\NormalTok{, }\DataTypeTok{add=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{yaxt=}\StringTok{"n"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
